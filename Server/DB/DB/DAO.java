...
public class DAO {
	...
	public static class ROOMDAO extends DAO {
		public static class Singleton {
			// 인스턴스를 하나만 만들겠다는 생각에 추가됨 덕분에 static를 도배 안해도됨
	...
	public static class BFDAO extends DAO {
		public static class Singleton {
			// 인스턴스를 하나만 만들겠다는 생각에 추가됨 덕분에 static를 도배 안해도됨
	...
	public static class STDAO extends DAO {
		public static class Singleton {
			// 인스턴스를 하나만 만들겠다는 생각에 추가됨 덕분에 static를 도배 안해도됨
		...
		public int getUserstate(String tbName,String id) {
			// 접속 인원 접속상태 불러오기
			try {
				con = getConn();
				String sql = "select member_state from " + tbName+" where st_id=?";
				int i;
				pstmt = con.prepareStatement(sql);
				pstmt.setString(1, id);
				rs = pstmt.executeQuery();
	...
	public static class GRDAO extends DAO {
		public static class Singleton {
			// 인스턴스를 하나만 만들겠다는 생각에 추가됨 덕분에 static를 도배 안해도됨
	...
	public static class MEMDAO extends DAO {
		public static class Singleton {
			// 인스턴스를 하나만 만들겠다는 생각에 추가됨 덕분에 static를 도배 안해도됨
